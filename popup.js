document.addEventListener('DOMContentLoaded', () => {
  ...
  const allStorageItems = ['topics', 'apiUrl', 'accessToken', 'prefillEnabled', 'darkModeEnabled'];
  ...
  async function loadConfig() {
    try {
      ...
      config = {
        ...
        darkModeEnabled: items.darkModeEnabled !== undefined ? !!items.darkModeEnabled : true,
      };
  ...
  function updateUI() {
    ...
    setElementChecked('darkmode', config.darkModeEnabled); // Set the dark mode checkbox
    updateTopicDropdown();
    prefillMessage();
  }

  // Toggles dark and light mode based on the darkModeEnabled setting.
